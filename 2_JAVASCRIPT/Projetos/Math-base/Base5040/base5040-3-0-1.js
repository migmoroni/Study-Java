...
function base5040ToDecimal(str) {
    // Adicionar 4352 (base5041 - 44032) para voltar ao intervalo 0-5039
    return str.codePointAt(0) - 44032;
}

function decimalToBase5040(decimal) {
    // Adicionar 4352 (base5041 - 44032) para mapear para os primeiros caracteres Hangul Syllables na tabela Unicode
...
function processInput(input) {
    ...
    if (option >= '1' && option <= '6') {
        ...
        if (isValidChar(value[0], option) || isValidChar(value[1], option)) {
            ...
            console.log(`Por favor, insira uma sequência válida na base ${option}.`);
        }
    }
