...
@export var meu_nome: String = "Davi"
...
@export var fixacao: String = "Uma variavel" #Minimo necessário para ficar correto
...
func _ready() -> void:
	print("Olá, meu nome é: " + meu_nome + ",\n" + um_nome_de_variavel + " " + fixacao)